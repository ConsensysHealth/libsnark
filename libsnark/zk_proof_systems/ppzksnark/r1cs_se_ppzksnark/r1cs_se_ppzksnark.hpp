...
template<typename ppT>
r1cs_se_ppzksnark_proof<ppT> r1cs_se_ppzksnark_prover_impl(const r1cs_se_ppzksnark_proving_key<ppT> &pk,
...
r1cs_se_ppzksnark_proof<ppT> r1cs_se_ppzksnark_prover(const r1cs_se_ppzksnark_proving_key<ppT> &pk,
                                                      ...
                                                      const r1cs_se_ppzksnark_auxiliary_input<ppT> &auxiliary_input)
{
  return PROFILEIT(r1cs_se_ppzksnark_prover_impl<ppT>)(pk, primary_input, auxiliary_input);
}
